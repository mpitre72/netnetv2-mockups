          ...
          h(
            item.disabled ? 'div' : 'button',
            {
              ...
              className: [
                ...
                item.disabled
                  ? 'cursor-not-allowed bg-slate-50/70 text-slate-400 dark:bg-white/[0.04] dark:text-slate-500'
                  : (item.tone === 'danger'
            ...
            [
              ...
              item.disabled && item.reason
                ? h('div', { className: 'mt-0.5 text-[11px] leading-4 text-slate-400 dark:text-slate-500' }, item.reason)
                : null,
            ]
          )
        )
