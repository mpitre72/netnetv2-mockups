      ...
      deliverables: [
          ...
          tasks: [
            {
              ...
              isDraft: false,
              isRecurring: true,
              recurringTemplateId: 'seed_plugin_updates',
              dueDate: '2026-04-15',
              cycleKey: null,
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4 },
              ],
            },
            {
              id: createId('task'),
              ...
              cycleKey: '2026-04',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12, actualHours: 11 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 3 },
              ],
            },
            {
              id: createId('task'),
              ...
              cycleKey: '2026-05',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12, actualHours: 12 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 3 },
              ],
            },
            {
              ...
              cycleKey: '2026-06',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12, actualHours: 8 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 2 },
              ],
            },
          ],
        },
        {
          ...
          tasks: [
            {
              id: createId('task'),
              title: 'Anything Hours',
              status: 'backlog',
              isDraft: false,
              isRecurring: true,
              recurringTemplateId: 'seed_anything_hours',
              dueDate: '2026-04-25',
              cycleKey: null,
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: seoId, loeHours: 18 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4 },
              ],
            },
            {
              ...
              cycleKey: '2026-04',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: seoId, loeHours: 20, actualHours: 18 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 4 },
              ],
            },
            {
              id: createId('task'),
              ...
              cycleKey: '2026-05',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: seoId, loeHours: 18, actualHours: 18 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 4 },
              ],
            },
            {
              ...
              cycleKey: '2026-06',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: seoId, loeHours: 18, actualHours: 12 },
                { id: createId('alloc'), assigneeUserId: teamIds[0], serviceTypeId: pmId, loeHours: 4, actualHours: 2 },
              ],
            },
          ],
          ...
          tasks: [
            {
              ...
              cycleKey: '2026-04',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: seoId, loeHours: 6, actualHours: 7 },
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 6, actualHours: 7 },
              ],
            },
          ],
        },
          ...
          tasks: [
            {
              ...
              cycleKey: '2026-05',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12, actualHours: 16 },
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: designId, loeHours: 6, actualHours: 8 },
              ],
            },
            {
              id: createId('task'),
              ...
              cycleKey: '2026-06',
              allocations: [
                { id: createId('alloc'), assigneeUserId: teamIds[1], serviceTypeId: devId, loeHours: 12, actualHours: 10 },
                { id: createId('alloc'), assigneeUserId: teamIds[3], serviceTypeId: designId, loeHours: 6, actualHours: 7 },
              ],
            },
          ],
        },
