export function renderResetSuccess(container = document.getElementById('app-main')) {
  if (!container) return;
  container.innerHTML = `
    <div class="relative z-10">
      <div class="w-full flex flex-col items-center px-4 sm:px-6 py-12 relative">
        ...
        <h1 class="text-4xl font-semibold text-gray-900 dark:text-white">Password updated</h1>
      </div>
...
if (typeof window !== 'undefined') {
  window.renderResetSuccess = renderResetSuccess;
}
