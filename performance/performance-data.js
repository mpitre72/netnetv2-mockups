...
export const performanceTasks = [
  { id: 't1', title: 'API endpoint mapping', deliverableId: 201, assigneeId: 'tm1', assignedAt: getDateShifted(-7), dueAt: getDateShifted(-2), status: 'completed', completedAt: getDateShifted(-1), estimatedHours: 50, actualHours: 28, remainingHours: null, serviceTypeId: 'web' },
  { id: 't2', title: 'Findings narrative', deliverableId: 202, assigneeId: 'tm2', assignedAt: getDateShifted(-8), dueAt: getDateShifted(3), status: 'in-progress', completedAt: null, estimatedHours: 30, actualHours: 10, remainingHours: null, serviceTypeId: 'consulting' },
  { id: 't3', title: 'Deployment readiness', deliverableId: 203, assigneeId: 'tm3', assignedAt: getDateShifted(-6), dueAt: getDateShifted(5), status: 'completed', completedAt: getDateShifted(-4), estimatedHours: 60, actualHours: 25, remainingHours: null, serviceTypeId: 'web' },
  { id: 't4', title: 'Wireframe polish', deliverableId: 204, assigneeId: 'tm4', assignedAt: getDateShifted(-15), dueAt: getDateShifted(12), status: 'in-progress', completedAt: null, estimatedHours: 90, actualHours: 32, remainingHours: null, serviceTypeId: 'ux' },
  { id: 't5', title: 'Device test matrix', deliverableId: 205, assigneeId: 'tm5', assignedAt: getDateShifted(-6), dueAt: getDateShifted(40), status: 'in-progress', completedAt: null, estimatedHours: 60, actualHours: 15, remainingHours: 35, serviceTypeId: 'mobile' },
  { id: 't6', title: 'Homepage copy pass', deliverableId: 206, assigneeId: 'tm6', assignedAt: getDateShifted(-27), dueAt: getDateShifted(7), status: 'in-progress', completedAt: null, estimatedHours: 80, actualHours: 24, remainingHours: null, serviceTypeId: 'web' },
  { id: 't7', title: 'Content migration checklist', deliverableId: 207, assigneeId: 'tm6', assignedAt: getDateShifted(-4), dueAt: getDateShifted(14), status: 'in-progress', completedAt: null, estimatedHours: 60, actualHours: 12, remainingHours: null, serviceTypeId: 'web' },
  { id: 't8', title: 'Technical SEO audit', deliverableId: 208, assigneeId: 'tm2', assignedAt: getDateShifted(-5), dueAt: getDateShifted(-1), status: 'completed', completedAt: getDateShifted(-1), estimatedHours: 50, actualHours: 50, remainingHours: 0, serviceTypeId: 'seo' },
  { id: 't9', title: 'Brand system refinement', deliverableId: 209, assigneeId: 'tm6', assignedAt: getDateShifted(-12), dueAt: getDateShifted(25), status: 'in-progress', completedAt: null, estimatedHours: 120, actualHours: 40, remainingHours: null, serviceTypeId: 'brand' },
  { id: 't10', title: 'Logo concept finalization', deliverableId: 210, assigneeId: 'tm6', assignedAt: getDateShifted(-7), dueAt: getDateShifted(-5), status: 'completed', completedAt: getDateShifted(-3), estimatedHours: 90, actualHours: 60, remainingHours: null, serviceTypeId: 'brand' },
  { id: 't11', title: 'Data mapping workshop', deliverableId: 211, assigneeId: 'tm2', assignedAt: getDateShifted(-6), dueAt: getDateShifted(-4), status: 'completed', completedAt: getDateShifted(-6), estimatedHours: 40, actualHours: 38, remainingHours: null, serviceTypeId: 'consulting' },
  { id: 't12', title: 'Performance tuning pass', deliverableId: 212, assigneeId: 'tm1', assignedAt: getDateShifted(-4), dueAt: getDateShifted(-1), status: 'in-progress', completedAt: null, estimatedHours: 55, actualHours: 30, remainingHours: null, serviceTypeId: 'web' },
  { id: 't13', title: 'Usability findings synthesis', deliverableId: 205, assigneeId: null, assignedAt: getDateShifted(-6), dueAt: getDateShifted(18), status: 'unassigned', completedAt: null, estimatedHours: 20, actualHours: 0, remainingHours: null, serviceTypeId: 'ux' }, // unassigned portion
  { id: 't14', title: 'Performance QA sweep', deliverableId: 212, assigneeId: 'tm5', assignedAt: getDateShifted(-3), dueAt: null, status: 'in-progress', completedAt: null, estimatedHours: null, actualHours: 0, remainingHours: null, serviceTypeId: 'web' }, // unknown estimate -> unknown demand
];
...
// -----------------------------------------------------------------------------
// Sales report seed data (Opportunity readiness + activity timeline)
// -----------------------------------------------------------------------------
...
export const performanceSalesDeals = [
  {
    ...
    status: 'won',
    value: 45000,
    linkedJobs: [{ id: 'job-quantum-phase-2', name: 'Quantum Leap Website Phase 2', status: 'active', href: '#/app/jobs/job-quantum-phase-2/tasks' }],
  ...
  },
  {
    ...
    status: 'open',
    value: 82000,
    linkedJobs: [{ id: 'job-appify-revamp', name: 'Mobile App Revamp', status: 'pending', href: '#/app/jobs/job-appify-revamp/plan' }],
  ...
  },
  {
    ...
    status: 'won',
    value: 26000,
    linkedJobs: [{ id: 'job-ncbf-redesign', name: 'NCBF Web Redesign Expansion', status: 'active', href: '#/app/jobs/job-ncbf-redesign/tasks' }],
  ...
  },
  {
    ...
    status: 'won',
    value: 15000,
    linkedJobs: [{ id: 'job-northwind-brand', name: 'Brand Refresh Quarterly', status: 'active', href: '#/app/jobs/job-northwind-brand/tasks' }],
  ...
  },
  {
    ...
    value: 0,
    linkedJobs: [],
    createdAt: getDateShifted(-4),
    closedAt: null,
  },
  {
    id: 'sd11',
    name: 'Summit Portal and Support',
    ...
    value: 64000,
    linkedJobs: [
      { id: 'job-summit-portal', name: 'Summit Portal Build', status: 'pending', href: '#/app/jobs/job-summit-portal/plan' },
      { id: 'job-summit-support', name: 'Summit Support Retainer', status: 'pending', href: '#/app/jobs/job-summit-support/plan' },
    ],
    createdAt: getDateShifted(-1),
    closedAt: null,
  },
];

export const performanceSalesActivities = [
  { id: 'sa1', dealId: 'sd6', date: getDateShifted(-2), type: 'Won', ownerId: 'tm1', note: 'Signed addendum and deposit received.' },
  { id: 'sa2', dealId: 'sd6', date: getDateShifted(-6), type: 'Scope refined', ownerId: 'tm1', note: 'Confirmed SOW and timeline.' },
  { id: 'sa3', dealId: 'sd5', date: getDateShifted(-1), type: 'Job linked', ownerId: 'tm4', note: 'Created pending Job for kickoff planning.' },
  { id: 'sa4', dealId: 'sd5', date: getDateShifted(-8), type: 'Opportunity created', ownerId: 'tm4', note: 'Captured stakeholders and success metrics.' },
  { id: 'sa5', dealId: 'sd2', date: getDateShifted(-3), type: 'Scope refined', ownerId: 'tm6', note: 'Adjusted scope and added brand guidelines.' },
  { id: 'sa6', dealId: 'sd2', date: getDateShifted(-14), type: 'Budget set', ownerId: 'tm6', note: 'Confirmed preferred package.' },
  { id: 'sa7', dealId: 'sd3', date: getDateShifted(-4), type: 'On Hold', ownerId: 'tm2', note: 'Paused while client confirms internal timing.' },
  { id: 'sa8', dealId: 'sd3', date: getDateShifted(-23), type: 'Scope workshop', ownerId: 'tm2', note: 'Aligned on deliverables and constraints.' },
  { id: 'sa9', dealId: 'sd4', date: getDateShifted(-12), type: 'Lost', ownerId: 'tm2', note: 'Client stayed with incumbent agency.' },
  { id: 'sa10', dealId: 'sd4', date: getDateShifted(-19), type: 'Follow-up', ownerId: 'tm2', note: 'Sent recap and next steps.' },
  { id: 'sa11', dealId: 'sd1', date: getDateShifted(-25), type: 'Won', ownerId: 'tm6', note: 'Approved budget and signed agreement.' },
  { id: 'sa12', dealId: 'sd1', date: getDateShifted(-31), type: 'Job linked', ownerId: 'tm6', note: 'Execution Job prepared for handoff.' },
  { id: 'sa13', dealId: 'sd9', date: getDateShifted(-7), type: 'Scope refined', ownerId: 'tm4', note: 'Shared audit outline and deliverables.' },
  { id: 'sa14', dealId: 'sd9', date: getDateShifted(-27), type: 'Opportunity created', ownerId: 'tm4', note: 'Identified key UX pain points.' },
  { id: 'sa15', dealId: 'sd8', date: getDateShifted(-2), type: 'Budget set', ownerId: 'tm2', note: 'Confirmed monthly budget range and urgency.' },
  { id: 'sa16', dealId: 'sd10', date: getDateShifted(-4), type: 'Opportunity created', ownerId: 'tm1', note: 'Captured support need, budget not set yet.' },
  { id: 'sa17', dealId: 'sd11', date: getDateShifted(-1), type: 'Job linked', ownerId: 'tm6', note: 'Prepared project and retainer Jobs for kickoff.' },
];
